...
is_deeply( $parser->{tags}, [ [ 0, 2, Int => 1 ] ], q("-4" tags) );
...
is_deeply( $parser->{spaces}, { }, q("0o20" spaces) );
is_deeply( $parser->{tags}, [ [ 0, 4, Int => 1 ] ], q("0o20" tags) );
